...
export const getEntity = async (entityCode: string, slug: string): Promise<DistributionEntity | null> => {
...
export const getAllEntities = async (entityCode: string, queryParameters: string): Promise<PagedResult | null> => {
...
export const getSelection = async (slug: string): Promise<PagedResult | null> => {
