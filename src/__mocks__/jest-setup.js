...
process.env.FORGE_DISTRIBUTION_API_BASE_URL = 'https://forge-dapi.com';
...
process.env.LIVE_BLOGGING_DAPI_BASE_URL = 'https://liveblogging.com';
process.env.DIVA_PLAYER_VIDEO_SETTINGS_BASE_URL = 'https://react-fe.net/diva5/settings';
