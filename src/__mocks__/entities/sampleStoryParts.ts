...
const partialYouTubePart = {
  ...
  content: {
    ...
    author_url: 'https://www.youtube.com/@Deltatre',
    type: 'video',
    height: 270,
    width: 480,
    version: '1.0',
...
const partialTwitterPart = {
  ...
  content: {
    ...
    author_url: 'https://twitter.com/NYCFC',
    type: 'rich',
    width: 550,
    version: '1.0',
