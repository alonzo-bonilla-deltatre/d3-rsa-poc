...
const HeaderTitle = ({
  ...
  const headingClassName = `${typographyHeadingClassName} text-component-commons-header-title-light dark:text-component-commons-header-title-dark`;
  ...
  return (
    <div
      className={`${getStringProperty(className)} flex items-center justify-between gap-2 lg:gap-6 text-component-commons-header-title-light dark:text-component-commons-header-title-dark`}
    >
