...
const MatchesCard = ({ todayItems, tomorrowItems, yesterdayItems }: MatchesCardProps) => {
  ...
  const selectedItemCssClass = 'border-b-accent border-b pb-4 mb-[-17px] text-black dark:text-white ';
  const navItemCssClass = 'font-navigation uppercase mr-8 cursor-pointer  text-xl -tracking-[0.02] ';

  return (
    <>
      <div className={'flex border-white/20 border-b pb-4 text-grey-300 dark:text-grey-100'}>
        <div
          ...
          >
            ...
            <div className={'hidden sm:grid sm:grid-cols-3 sm:gaps-4 justify-between min-h-[320px]'}>
              ...
              <div className={'flex flex-col justify-between items-center'}>
                {entity?.fields?.venue && (
                  <div className={'matches-venue-watermark uppercase'}>{entity?.fields?.venue ?? ''}</div>
                )}
