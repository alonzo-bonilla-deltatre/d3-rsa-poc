...
import { CommonHeaderScrollManager } from '@/components/commons/CommonHeader/CommonHeaderScrollManager';
import { AzureSearchOption } from '@/models/types/azureSearch';
import { translate } from '@/helpers/translationHelper';
import { enrichPageVariables, getPageStructureFromVariablePath } from '@/helpers/pageHelper';
...
const CommonHeader = ({ data }: { data: CommonHeaderProps }) => {
  ...
  return (
    ...
    >
      {isTransparent && (
        <CommonHeaderScrollManager
          transparentClasses={['bg-transparent']}
          defaultColor={`${getBooleanProperty(isDark) ? 'bg-component-commons-common-header-background-dark' : 'bg-component-commons-common-header-background-light'}`}
        />
      )}
      <nav
        id="header-nav"
        ...
        className={`flex flex-col justify-center ${
          isTransparent
            ? 'transition-colors duration-200 ease-linear text-component-commons-common-header-text-light dark:text-component-commons-common-header-text-dark fixed top-0 left-0 right-0'
            : 'bg-component-commons-common-header-background-light dark:bg-component-commons-common-header-background-dark'
        }`}
      >
        <div className="h-header-height container px-4 grid grid-cols-3 grid-flow-row gap-4 md:items-center md:justify-between">
          ...
          <div
            className={`flex justify-end hidden lg:flex ${getBooleanProperty(isDark) ? 'text-component-commons-common-header-text-dark' : 'text-component-commons-common-header-text-light'}`}
        ...
        <div className="container px-4 hidden lg:block">
          ...
          >
            <div className="container mx-auto lg:text-center">
              <div
                className={`flex flex-row uppercase items-center justify-center flex-wrap lg:justify-between ${getBooleanProperty(isDark) ? 'text-component-commons-common-header-text-dark' : 'text-component-commons-common-header-text-light'}`}
              >
                {renderItemsInSlot(
                  data.items,
          ...
          <div
            className={`w-full flex items-center justify-center ${getBooleanProperty(isDark) ? 'bg-component-commons-common-header-background-light text-component-commons-common-header-text-light' : 'bg-component-commons-common-header-background-dark text-component-commons-common-header-text-dark'}`}
          ...
          <div
            className={`w-full flex items-center ${getBooleanProperty(isDark) ? 'text-component-commons-common-header-text-dark' : 'text-component-commons-common-header-text-light'}`}
