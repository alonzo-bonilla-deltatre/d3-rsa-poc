...
const Header = async (): Promise<React.ReactElement> => {
  ...
  return (
    <>
    <HeaderElement menuData={menuData} menuItemClasses={navItemClasses} iconSize={iconSize} logo={logo} logoWidth={226} logoHeight={25} logoName={"Poc"} logoLink={"/test/react-poc/demo"}></HeaderElement>
    </>
  );
};
