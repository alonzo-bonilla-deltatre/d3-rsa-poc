...
describe("getSrcWithTransformation", (): void => {
  const photoUrl =
    "https://res.cloudinary.com/d3/image/upload/{formatInstructions}/dev/e2wmqxju9vnrl6po1jim";
  ...
  test("should remove formatInstructions", (): void => {
    ...
    // ASSERT
    expect(result).toEqual(
      "https://res.cloudinary.com/d3/image/upload/t_thumb/dev/e2wmqxju9vnrl6po1jim"
    );
  });
});
